...
import { parseAndCompile } from "../src";import { Op, I32, Void, c, BufferedEmitter, LocalEntry, Int, VarUint32, ExportEntry, FunctionBody, FuncType } from "../../wasm";
    ...
    switch (expr.type) {
        ...
        case "bin": {
            ...
            switch (expr.operation) {
                ...
                default:
                    throw new Error(`Unknown binary operator ${expr.operation}`);
            }
        }
